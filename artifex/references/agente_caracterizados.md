...
- Cada ejercicio tiene espacio de respuesta con `\underline{\hspace{6cm}}` o `$$\underline{\hspace{6cm}}$$` (dentro de math mode).
...
Lee el bloque de teoria y la contextualización de Feynman. Identifica:
